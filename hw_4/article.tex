...
\noindent(If reused of ``banned'' route $E \rightarrow F$ is not allowed, then the second best path is $E \rightarrow D \rightarrow F$ with a cost of $6$. However, it is not explicitly restricted by the question so I guess $B$ is still the best neighbor to go with. I am providing this alternative solution just in case.)
